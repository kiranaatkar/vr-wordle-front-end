...
After submitting a username, the page will begin to load the app, after which a prompt will appear at the bottom of the page, allowing the user to enter a WebXR-powered interactive experience.
